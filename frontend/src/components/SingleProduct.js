...
const SingleProduct = () => {
  ...
  useEffect(() => {
    axios(`/api/v1/dresses/${id}`).then(({data}) => setProduct(data))
  }, [id])
  return (
    <>
      {product ? <Layout>
        <div className="lg:w-4/5 mx-auto flex flex-wrap py-10">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">{product.brand}E</h2>
          ...
          <span className="flex items-center">
            ...
            <p className="leading-relaxed">Fam locavore kickstarter distillery. Mixtape chillwave tumeric sriracha
              taximy chia microdosing tilde DIY. XOXO fam indxgo juiceramps cornhole raw denim forage brooklyn. Everyday
              carry +1 seitan poutine tumeric. Gastropub blue bottle austin listicle pour-over, neutra jean shorts
            ...
            <div className="flex">
              ...
              <button
                className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Add
                to cart
              </button>
              <button
